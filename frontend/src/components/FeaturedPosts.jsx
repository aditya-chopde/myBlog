...
const FeaturedPosts = () => {
  return (
    <>
      <div className="my-10 flex flex-col justify-around items-center">
          <div className="bg-purple-600 text-white text-center py-2 text-xl px-5">
            Featured
          </div>
            ...
            <div className="my-10 w-[250px]">
              ...
              <div>
                ...
                <p className="text-sm">
                  ...
                  Maxime excepturi nisi asperiores illo voluptas quasi facilis
                  dolores! Eum, ipsa corporis..
                </p>
              </div>
            </div>
            <div>
